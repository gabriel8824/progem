...
class PaginaCobrancasV3PagasWidget extends StatefulWidget {
  const PaginaCobrancasV3PagasWidget({
    Key? key,
    this.filtro,
  }) : super(key: key);
  ...
  @override
  _PaginaCobrancasV3PagasWidgetState createState() =>
      _PaginaCobrancasV3PagasWidgetState();
}

class _PaginaCobrancasV3PagasWidgetState
    extends State<PaginaCobrancasV3PagasWidget> {
