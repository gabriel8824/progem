...
class PaginaCobrancasBuscarNomeWidget extends StatefulWidget {
  const PaginaCobrancasBuscarNomeWidget({
    Key? key,
    this.filtro,
  }) : super(key: key);
  ...
  @override
  _PaginaCobrancasBuscarNomeWidgetState createState() =>
      _PaginaCobrancasBuscarNomeWidgetState();
}

class _PaginaCobrancasBuscarNomeWidgetState
    extends State<PaginaCobrancasBuscarNomeWidget> {
                                                ...
                                                _pagingController!
                                                  ...
                                                  ApiProgemGroup
                                                    ...
                                                    nome: textController1!.text,
                                                      ...
                                                      .then(
                                                          (listViewListarCobrancasNomeClienteResponse) {
                                                    final pageItems = ApiProgemGroup
                                                        .listarCobrancasNomeClienteCall
                                                        .dados(
                                                          listViewListarCobrancasNomeClienteResponse
                                                              .jsonBody,
