...
class PaginaCobrancasV3AtrasadasWidget extends StatefulWidget {
  const PaginaCobrancasV3AtrasadasWidget({
    Key? key,
    this.filtro,
  }) : super(key: key);
  ...
  @override
  _PaginaCobrancasV3AtrasadasWidgetState createState() =>
      _PaginaCobrancasV3AtrasadasWidgetState();
}

class _PaginaCobrancasV3AtrasadasWidgetState
    extends State<PaginaCobrancasV3AtrasadasWidget> {
