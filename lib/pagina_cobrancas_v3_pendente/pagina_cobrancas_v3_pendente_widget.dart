...
class PaginaCobrancasV3PendenteWidget extends StatefulWidget {
  const PaginaCobrancasV3PendenteWidget({
    Key? key,
    this.filtro,
  }) : super(key: key);
  ...
  @override
  _PaginaCobrancasV3PendenteWidgetState createState() =>
      _PaginaCobrancasV3PendenteWidgetState();
}

class _PaginaCobrancasV3PendenteWidgetState
    extends State<PaginaCobrancasV3PendenteWidget> {
