...
/// Functions to query CobrancasRecords (as a Stream and as a Future).
Future<int> queryCobrancasRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
...
Stream<List<CobrancasRecord>> queryCobrancasRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<CobrancasRecord>> queryCobrancasRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<CobrancasRecord>> queryCobrancasRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
...
/// Functions to query CaixasRecords (as a Stream and as a Future).
Future<int> queryCaixasRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      CaixasRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<CaixasRecord>> queryCaixasRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<CaixasRecord>> queryCaixasRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<CaixasRecord>> queryCaixasRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
...
/// Functions to query CobrancasRealizadasRecords (as a Stream and as a Future).
Future<int> queryCobrancasRealizadasRecordCount({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      CobrancasRealizadasRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<CobrancasRealizadasRecord>> queryCobrancasRealizadasRecord({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
...
Future<List<CobrancasRealizadasRecord>> queryCobrancasRealizadasRecordOnce({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
...
Future<FFFirestorePage<CobrancasRealizadasRecord>>
