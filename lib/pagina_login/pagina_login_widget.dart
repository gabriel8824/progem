...
class _PaginaLoginWidgetState extends State<PaginaLoginWidget> {
  ...
  List<PageAtualUserRecord> simpleSearchResults = [];
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<PageAtualUserRecord>>(
      future: queryPageAtualUserRecordOnce(),
      builder: (context, snapshot) {
        ...
        List<PageAtualUserRecord> paginaLoginPageAtualUserRecordList =
            snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
                                ...
                                if ((resLogin?.succeeded ?? true)) {
                                  ...
                                  setState(() {
                                    simpleSearchResults = TextSearch(
                                      paginaLoginPageAtualUserRecordList
                                          .map(
                                            (record) => TextSearchItem(
                                                record, [record.emailUser!]),
                                          )
                                          .toList(),
                                    )
                                  ...
                                  if (simpleSearchResults.length < 1) {
                                    final pageAtualUserCreateData =
                                        createPageAtualUserRecordData(
                                      emailUser: textController1!.text,
                                      pagina: 0,
                                    );
                                    await PageAtualUserRecord.collection
                                        .doc()
                                        .set(pageAtualUserCreateData);
                                  }
