                    ...
                    Align(
                      ...
                      child: StreamBuilder<List<PageAtualUserRecord>>(
                        stream: queryPageAtualUserRecord(
                          queryBuilder: (pageAtualUserRecord) =>
                              pageAtualUserRecord.where('EmailUser',
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<PageAtualUserRecord>
                              columnPageAtualUserRecordList = snapshot.data!;
                                                        ...
                                                        callback:
                                                          ...
                                                          if (FFAppState()
                                                            ...
                                                            if (simpleSearchResults
                                                              ...
                                                              FFAppState()
                                                                  .update(() {
                                                                FFAppState().removeFromCobrancasOffV2(
                                                                    FFAppState()
                                                                        .CobrancaAtual);
                                                              });
                                                              FFAppState()
