...
class PaginaCobrancasReagendadsWidget extends StatefulWidget {
  const PaginaCobrancasReagendadsWidget({
    Key? key,
    this.filtro,
  }) : super(key: key);
  ...
  @override
  _PaginaCobrancasReagendadsWidgetState createState() =>
      _PaginaCobrancasReagendadsWidgetState();
}

class _PaginaCobrancasReagendadsWidgetState
    extends State<PaginaCobrancasReagendadsWidget> {
                                              ...
                                              _pagingController!
                                                ...
                                                ApiProgemGroup
                                                  ...
                                                  token: FFAppState().token,
                                                    ...
                                                    .then(
                                                        (listViewListarCobrancasReagendadaResponse) {
